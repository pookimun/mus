...
public class ExampleController {
    ...
    public ExampleController() {
        ...
        this.messageService = NurigoApp.INSTANCE.initialize("NCS2CSODAAIXZYZG", "9RXS0WKQMD1XZAM7HPAXBVT63HOKA9CX", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        message.setFrom("01075619009");
        message.setTo("01075619009");
        message.setText("[itc | 비밀번호 찾기] 입력하실 인증번호는 " + numStr + " 입니다.");
